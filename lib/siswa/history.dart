...
class HistorySiswa extends StatefulWidget {
  const HistorySiswa({super.key});

  @override
  State<HistorySiswa> createState() => _HistorySiswaState();
}

class _HistorySiswaState extends State<HistorySiswa> {
  List<dynamic> data = [];
  final networking = Networking();
  void load() async {
    data = await networking.getOrder();
    if(mounted){
    setState(() {});
    }
  }
